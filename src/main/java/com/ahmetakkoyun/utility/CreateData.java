...
//
        ...
        UserInformation userInformation=UserInformation.builder().firstName("Ahmet")
                .lastName("Akkoyun")

                .phoneNumber("5555-555-55-5")
                .about("hakkımda......ahmet akkoyun....")
                .address(Set.of(address1 ,address2))
                .build();

        UserInformation userInformation2=UserInformation.builder().firstName("Cemal")
                .lastName("Demir")

                .phoneNumber("5555-555-55-5")
                .about("hakkımda.......cemal demir...")
        ...
        UserInformation userInformation3=UserInformation.builder().firstName("Derya")
                ...
                .phoneNumber("5555-555-55-5")
                .about("hakkımda...derya yılmaz......")
                .address(Set.of(address5 ,address6))
                .build();

        Users user= Users.builder().username("ahmet").password("123")
                .userInformation(userInformation)
                .build();
        Users user2=Users.builder().username("cemal").password("123").userInformation(userInformation2).build();
